...
class MainGameEventHandler(EventHandler):
    ...
    #        player.vertical_movement = 0
        ...
        elif key == tcod.event.KeySym.h:  # h for history
            return HistoryViewer(self.engine)

        elif key == tcod.event.KeySym.g:  # g for get item
            action = PickupAction(player)

        elif key == tcod.event.KeySym.v:  # v for view inventory
            return InventoryActivateHandler(self.engine)
        elif key == tcod.event.KeySym.d:  # d for drop item
